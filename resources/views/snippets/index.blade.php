                        ...
                        <div class="media-content">
                            <div class="content">
                                <p>
                                    ...
                                    <br>
                                    <small>{{ 'By : @'.$snippet->owner->slug.' - ' }}</small>
                            ...
                            <nav class="level">
                                <div class="level-left">
                                    @if(Auth::id() === $snippet->owner->id)
                                        <a class="level-item button is-warning"
                                    ...
                                    <div class="box">
                                        <article class="media">
                                            <div class="media-content">
                                                <div class="content">
                                                    <p>
                                                        <strong><a href="{{ url('snippets/'.$snippet->slug) }}"
                                                                   id="snippet-title">{{ $snippet->title }}</a></strong>
                                                        <br>
                                                ...
                                                <nav class="level">
                                                    <div class="level-left">
                                                        ...
                                                        <a class="level-item button is-info"
                                                           href="/snippets/{{ $snippet->slug }}/fork">
                                                            <span class="icon is-small"><i class="fa fa-code-fork"></i></span>
                                                        </a>
                                                        <like :snippet_id="{{ $snippet->id }}"></like>
                                                    </div>
